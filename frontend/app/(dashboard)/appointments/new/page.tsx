      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            ...
            <input {...register('scheduledAt')} id="scheduledAt" type="datetime-local" autoComplete="off"
              className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-pink-400" />
          ...
          <div>
            ...
            <input {...register('duration')} id="duration" type="number" min={15} max={180} step={15} autoComplete="off"
              className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-pink-400" />
          </div>

          <div>
            <label htmlFor="location" className="block text-sm font-medium text-gray-700 mb-1.5">Location (optional)</label>
            <input {...register('location')} id="location" type="text" autoComplete="off" placeholder="Clinic address or meeting link"
              className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-pink-400" />
          </div>
